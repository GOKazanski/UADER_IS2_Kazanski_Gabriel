...
5. Extienda el ejemplo visto en el taller en clase de forma que se pueda utilizar para construir aviones en lugar de vehículos. Para simplificar suponga que un avión tiene un “body”, 2 turbinas, 2 alas y un tren de aterrizaje.
